...
questions_list.append(
        Question('самый популярный язык в мире', 'хинди', 'Английский', 'Испанский', 'российский'))
questions_list.append(
        Question('какой настоящий цвет солнца?', 'Зелёный', 'Красный', 'Белый', 'желтый'))
questions_list.append(
        Question('сколько дней в мае', '31', '30', '32', '28'))
